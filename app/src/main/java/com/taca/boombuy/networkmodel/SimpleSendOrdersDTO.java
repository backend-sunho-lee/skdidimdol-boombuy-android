...
public class SimpleSendOrdersDTO {
    ...
    public SimpleSendOrdersDTO() {
    }

    public SimpleSendOrdersDTO(int oid, String state, String orderstime, String receiver, String receiverphoto, String sender, String senderphoto, int cnt) {
        this.oid = oid;
        this.state = state;
